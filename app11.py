...
if __name__ == '__main__':
    ...
    # Устанавливаем таймауты сокета
    socket.setdefaulttimeout(120)  # 120 секунд для Яндекс Диалогов
    ...
    try:
        ...
        app.run(
            ...
            use_reloader=False  # Отключаем релоад в продакшене
        )
